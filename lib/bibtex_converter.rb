module BibtexConverter
  ...
  def convert_one(data)
    ...
    converted << "year = {#{data.year}}," unless data.year.nil? || data.year.empty?
    ...
    converted << "volume = {#{data.volume}}," unless data.volume.nil? || data.volume.empty?
    ...
    converted << "series = {#{data.series}}," unless data.series.nil? || data.series.empty?
